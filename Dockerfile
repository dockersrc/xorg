# Docker image for xorg using the xorg template
ARG IMAGE_NAME="xorg"
ARG PHP_SERVER="xorg"
ARG BUILD_DATE="202606261529"
...
LABEL org.opencontainers.image.documentation="https://github.com/dockersrc/xorg"
